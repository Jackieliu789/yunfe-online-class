...
public class GenerateUserSig {
    ...
    public String genUserSig(String userId) {
        ...
        String videoKey = config.get("videoKey");
        String videoSecret = config.get("videoSecret");
        if (StringUtils.isEmpty(videoKey) || StringUtils.isEmpty(videoSecret)) {
            return null;
        }
        return GenTLSSignature(Integer.parseInt(videoKey), userId, expireTime, null, videoSecret);
    }

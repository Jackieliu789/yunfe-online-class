...
public class TEduBoardUserSig {
    ...
    public String genUserSig(String userId) {
        ...
        String boardKey = config.get("boardKey");
        String boardSecret = config.get("boardSecret");
        if (StringUtils.isEmpty(boardKey) || StringUtils.isEmpty(boardSecret)) {
            return null;
        }
        return GenTLSSignature(Integer.parseInt(boardKey), userId, expireTime, null, boardSecret);
    }
    ...
    private String hmacsha256(long sdkappid, String userId, long currTime, long expire, String priKeyContent, String base64Userbuf) {
        ...
        try {
            ...
            return new String(Base64.encodeBase64String(byteSig));
    ...
    private static byte[] base64EncodeUrl(byte[] input) {
        byte[] base64 = new String(Base64.encodeBase64String(input)).getBytes();
    ...
    /*public static void main(String[] args) {
        TEduBoardUserSig userSig = new TEduBoardUserSig();
        String s = userSig.genUserSig("5e7f32934d473615acfc18e1");

...
<body>
	<div class="ui-form">
		<form class="layui-form ajax-form" action="${params.contextPath}/web/chatRecord/<#if (params.id)??>modify<#else>save</#if>.json" method="post">
			...
			<div class="layui-form-item">
                <label class="layui-form-label">提问内容<span class="ui-request">*</span></label>
                <div class="layui-input-block">
                    <input type="text" name="content" placeholder="请输入提问内容" class="layui-input"/>
                </div>
            </div>
			<div class="layui-form-item">

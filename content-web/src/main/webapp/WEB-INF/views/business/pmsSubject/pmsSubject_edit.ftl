    ...
    <div class="ui-form">
        <form class="layui-form" @submit.prevent="submitForm()" method="post">
            ...
            <div class="layui-form-item">
                <label class="layui-form-label">专栏名称<span class="ui-request">*</span></label>
                <div class="layui-input-block">
                    <input type="text" v-model="record.name" placeholder="请输入名称" class="layui-input"/>
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">专栏简介<span class="ui-request">*</span></label>
                <div class="layui-input-block">
                    <textarea v-model="record.intro" placeholder="请输入专栏简介" class="layui-textarea"></textarea>
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">专栏封面<span class="ui-request">*</span></label>
                <div class="layui-input-block">
            ...
            <div class="layui-form-item">
                <label class="layui-form-label">商家信息<span class="ui-request">*</span></label>
                <div class="layui-input-block">
                    <textarea v-model="record.businessInfo" placeholder="请输入商家信息" class="layui-textarea"></textarea>
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">专栏详情<span class="ui-request">*</span></label>
                <div class="layui-input-block">
    ...
    var app = new Vue({
        ...
        methods: {
            ...
            submitForm: function () {
                ...
                $.http.post("${params.contextPath}/web/pmsSubject/<#if (params.id)??>modify<#else>save</#if>.json", this.record).then(function (data) {
                    if (!data.success) {
                        $.message(data.message);
                        return;
                    }
